...
const PatientMedications = () => {
  ...
  const getTimeIcon = (time: string) => {
    ...
    if (hour < 12) return <Sun className="h-4 w-4 text-gray-500" />;
    if (hour < 17) return <CloudSun className="h-4 w-4 text-gray-500" />;
            ...
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
                  ...
                  <CardContent>
                    <Calendar
                      ...
                      modifiersClassNames={{
                        ...
                        mediumAdherence: "bg-gray-200 text-gray-700 font-semibold hover:bg-gray-300",
                    ...
                    <div className="mt-6 space-y-2 rounded-lg border border-gray-200 bg-white p-4">
                      ...
                      <div className="space-y-2 text-xs">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-gray-600">≥75% adherence</span>
                        </div>
                        <div className="flex items-center gap-2">
              ...
              <div className="lg:col-span-2">
                ...
                {["Morning", "Afternoon", "Evening"].map((period) => {
                  ...
                  const periodIcon = period === "Morning" ? <Sun className="h-5 w-5 text-gray-500" />
                    : period === "Afternoon" ? <CloudSun className="h-5 w-5 text-gray-500" />
                          ...
                          {periodLogs.map((log) => {
                            ...
                            return (
                              <div
                                ...
                                className={`flex items-center gap-3 rounded-lg border-2 p-3 transition-all ${log.status === "taken"
                                    ? "border-gray-300 bg-gray-50"
                                    : log.status === "missed"
                                      ? "border-gray-300 bg-gray-50"
                                      : "border-gray-200 bg-white hover:border-red-300"
                                  } ${isHighlighted ? "ring-4 ring-red-300 ring-opacity-50 animate-pulse" : ""
                                  }`}
                              >
                                <div className={`flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-lg ${log.status === "taken"
                                ...
                                <div className="flex-1">
                                  <div className="flex items-center gap-2">
                                    ...
                                    {log.status === "taken" && (
                                      <Badge className="bg-gray-600 text-xs">Taken</Badge>
                                    )}
                                    {log.status === "missed" && (
                        ...
                        <div key={dateStr} className="rounded-lg border-2 border-gray-200 p-5">
                          <div className="mb-4 flex items-center justify-between border-b border-gray-200 pb-3">
                            ...
                            <div className="text-right">
                              <div className={`text-2xl font-bold ${rate >= 75 ? "text-red-600" : "text-gray-600"
                                }`}>
                                {rate}%
                              </div>
